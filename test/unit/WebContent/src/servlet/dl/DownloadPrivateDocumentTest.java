...
/** */
public class DownloadPrivateDocumentTest extends TestCase {
	/**
	 * 
	 * @return o
	 * @throws Exception
	...
	public static Test suite() throws Exception {
		TestSuite suite = new TestSuite(DownloadPrivateDocumentTest.class);
	...
	public void testMe() throws Exception {
		EIMObject obj = TestAppObjectUtil.getObj(sess, "F編集中3.txt");
		String assertStr = obj.getId() + "," + AppObjectUtil.getStrAttr(sess, obj, "パス")
				+ obj.getName();
		// 書き込み権
		ds.switchUser("tu1");
		assertEquals(assertStr, ds.servlet_dl_DownloadPrivateDocument(obj.getId()));
		...
		// 公開読み取り権
		ds.switchUser("tu4");
		assertTrue(ds.servlet_dl_DownloadPrivateDocument(obj.getId()).indexOf(
			"alert(\"アクセス権限がありません。\");") > 0);
	}
}
