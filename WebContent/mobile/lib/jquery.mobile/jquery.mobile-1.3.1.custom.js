...
$.mobile.document.delegate( ":jqmData(role='table')", "tablecreate refresh", function( e ) {
	...
	if ( event !== "refresh" ) {
	    ...
	    /*=====I'm putting this first, for avoid an undefined $switchboard=====*/
	...
	if ( event === "refresh" ){
	    $switchboard.html(""); /* cleaning previous checkbox */
	}
	...
	self.headers.not( "td" ).each(function( i ) {
	    ...
	    if ( priority ) {
	        ...
	        //if ( event !== "refresh" ) { /* commented for working on refresh */
	            $("<label><input type='checkbox' checked />" + $( this ).text() + "</label>" )
	                .appendTo( $switchboard ) /* change from $menu to $switchboard */
	                .children( 0 )
	                .jqmData( "cells", $cells )
	                .checkboxradio({
