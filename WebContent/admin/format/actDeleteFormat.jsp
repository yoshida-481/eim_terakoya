...
<%
	...
	try
	{
		...
		OperationHistoryUtils.create(sess, AppConstant.SYSTEM, EIMConstant.DELETE_FORMAT, 
				EIMConstant.TARGET_DELETE, EIMConstant.FORMAT, format,
				null, null, null, null);
		
		//Delete
		FileUtils.deleteFormat(sess, format);
