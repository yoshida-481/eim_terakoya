...
<%
	...
	try
	{
		...
		//Root Node
		out.println("<relationTypes>");

		//Relation Type List
		List relTypeList = RelationUtils.getRelationTypeList(sess);

		for(int i = 0; i < relTypeList.size(); i++)
		{
			//RelationType
			EIMRelationType relationType = (EIMRelationType)relTypeList.get(i);

			//XML
			out.println("<relationType");
				out.println(" label=\"" + StringUtils.xmlEncode(relationType.getName()) + "\"");
