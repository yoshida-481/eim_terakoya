...
<%
	...
	try
	{
		...
		//Get Parent Group
		EIMGroup parentGroup = group.getParent();
		
		//Create Operation History
		if(parentGroup != null)
		{
			OperationHistoryUtils.create(sess, AppConstant.SYSTEM, EIMConstant.DELETE_GROUP, 
					EIMConstant.TARGET_PARENT_GROUP, EIMConstant.GROUP, parentGroup,
					EIMConstant.TARGET_DELETE, EIMConstant.GROUP, group, null );
		}
		else
		{
			OperationHistoryUtils.create(sess, AppConstant.SYSTEM, EIMConstant.DELETE_GROUP, 
					EIMConstant.TARGET_DELETE, EIMConstant.GROUP, group,
					null, null, null, null );
		}

		//Delete
		GroupUtils.deleteGroup(sess, group);
