...
<%
//-----------------------------------------------------------------------------------------------
//app/document/object/actUpdateAttribute.jspをコピーして追加修正
//-----------------------------------------------------------------------------------------------
	...
	try
	{
		...
		//アクセス権限チェック
		if (helper.isTypeOfFolder(object.getType()))	//<---フォルダである場合はありえないはず
		{
			// ドキュメントのリレーションタイプ取得
		...
		else if (helper.isTypeOfWorkspace(object.getType()))	//<---今回対象となる処理
		{
