...
public class DocumentCriteria {
	...
	/**
	 * ドキュメントIDに対する検索条件を取得します。<br>
	 * @return ドキュメントIDに対する検索条件
	 * @since Ver 1.0
	 */
	...
	/**
	 *  ドキュメントIDに対する検索条件を設定します。<br>
	 * @param ids  ドキュメントIDに対する検索条件
	 * @since Ver 1.0
	 */
	...
	/**
	 * ドキュメントタイプIDに対する検索条件を取得します。
	 * @return ドキュメントタイプIDに対する検索条件<br>
	 * @since Ver1.0
	 */
	...
	/**
	 * ドキュメントタイプIDに対する検索条件を設定します。
	 * @param objectTypeId ドキュメントタイプID<br>
	 * @since Ver1.0
	 */
