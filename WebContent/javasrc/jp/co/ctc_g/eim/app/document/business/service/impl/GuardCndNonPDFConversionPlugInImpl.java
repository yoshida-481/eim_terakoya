 ...
 * 
 */
public class GuardCndNonPDFConversionPlugInImpl extends GuardConditionPlugInImpl {
	...
	public void doAction(GuardConditionExecDomain guardConditionExecDomain) throws Exception
	{
		...
		// PDF関連設定を行う
		ApproveCommonUtil.doPublishCommandOnlineNonConvert(sess, object);
