...
/**
 * 【ドキュメントAPI】
 * 入力値としてDocumentDomainを受け取り、ObjectDomainインスタンスを生成するプラグインクラスです。
 * @since Ver1.0
 */
public class DocumentDomainToObjectConverterPlugInImpl implements ParameterConverterPlugIn {
	/**
	 * DocumentDomainを受け取り、ObjectDomainインスタンスをnewして返却します。
	 * @param source DocumentDomainです。
	 * @return IDをコンストラクタに設定してnewしたObjectDomainインスタンスです。
	 * @since Ver1.0
	 */
	public Object convert(Object source) throws Exception {
		DocumentDomain domain = (DocumentDomain)source;
