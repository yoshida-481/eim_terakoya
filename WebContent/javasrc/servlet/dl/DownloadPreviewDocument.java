...
/**
 * プレビュードキュメントをダウンロードするDownloadサーブレット。
 * <p>
 * このクラスは
 ...
 * @since		1.0.0
 */
public class DownloadPreviewDocument extends AbstractDownloadDocument
{
	/**
	 *
	 */
	...
	EIMFormat getFormat(EIMSession session, EIMObject object) throws Exception {
		EIMFormat format = FileUtils.getFormatByName(session, EIMConfig.get("FORMAT_NAME_PREVIEW"));
		return format;
	}
}