...
/**
 * オブジェクトタイプ「タグ」指定の検索条件定義クラス
 *
 */
public class ObjTypeTagConditionMaker extends EIMDocSearchConditionMaker {
	 ...
	 * @param userData
	 */
	public ObjTypeTagConditionMaker(EIMDocSearchType type, Object userData) {
		super(type, userData);
	}
	...
	public EIMSearchConditionGroup getDefaultCondition() throws Exception {
		...
		// 検索条件1：オブジェクトタイプが「タグ」。そのサブクラスも対象。
