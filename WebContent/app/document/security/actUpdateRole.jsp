...
<%
	...
	try
	{
		...
		if (stSec == null) {
			CreateOpeHistUtil.createUpdateSecurityEntryRoleHistory(sess, null, entry, entryType, AppConstant.DOCUMENT);
		} else {
			CreateOpeHistUtil.createUpdateStatusSecurityEntryRoleHistor(sess, stSec, entry, entryType, AppConstant.DOCUMENT);
		}
