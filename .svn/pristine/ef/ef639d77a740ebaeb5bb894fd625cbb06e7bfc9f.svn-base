...
/** */
public class DspApproveDocumentListTest extends TestCase {
	/** */
	DocumentService ds;
	...
	public void testMe() throws Exception
	{
		...
		assertEquals(String.valueOf(docObj.getId()), XPathAPI.selectSingleNode(xu.toDOM(ds.approve_dspApproveDocumentList()),
				"objList/object/@objId").getNodeValue());

		// @Test: 0 approve requested to u2
		switchServiceUser("u2");
		assertNull(XPathAPI.selectSingleNode(xu.toDOM(ds.approve_dspApproveDocumentList()),
		"objList/object/@objId"));
	}
