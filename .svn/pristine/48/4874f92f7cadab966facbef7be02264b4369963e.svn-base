...
<%
	...
	try
	{
		...
		//Get old info
		EIMObjectType parentObjType = objType.getParent();
		
		//Create Operation History
		if(parentObjType != null)
		{
			OperationHistoryUtils.create(sess, AppConstant.SYSTEM, EIMConstant.DELETE_CLASS, 
					EIMConstant.TARGET_PARENT_CLASS, EIMConstant.OBJECT_TYPE, parentObjType,
					EIMConstant.TARGET_DELETE, EIMConstant.OBJECT_TYPE, objType, null);
		}
		else
		{
			OperationHistoryUtils.create(sess, AppConstant.SYSTEM, EIMConstant.DELETE_CLASS, 
					EIMConstant.TARGET_DELETE, EIMConstant.OBJECT_TYPE, objType,
					null, null, null, null);
		}

		//Delete
		ObjectUtils.deleteObjectType(sess, objType);
