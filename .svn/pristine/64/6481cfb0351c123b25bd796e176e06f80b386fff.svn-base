...
<%
	...
	try
	{
		...
		//Release
		StatusAttributeUtils.releaseAttributeType(sess, statusType, attType);
		...
		OperationHistoryUtils.create(sess, AppConstant.SYSTEM, EIMConstant.RELEASE_STATUS_ATTRIBUTE, 
