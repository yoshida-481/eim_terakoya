...
<%
	...
	try
	{
		...
		//Root Node
		out.println("<attrTreeList>");
		
		for(int i = 0; i < attributeTreeList.size(); i++)
		{
			//Attribute Tree
			AttributeTree attributeTree = (AttributeTree)attributeTreeList.get(i);
			
			//XML
			out.println("<attrTree");
				out.println(" attrTreeId=\"" + attributeTree.getId() + "\"");
				out.println(" attrTreeName=\"" + StringUtils.xmlEncode(attributeTree.getName()) + "\"");
			out.println(">");
			out.println("</attrTree>");
		}
