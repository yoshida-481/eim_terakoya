	...
	try
	{
		...
		if(entryType.getId() == EIMAccessEntryType.USER)
		{
			...
			if(workFlow != null)
			{
				...
				OperationHistoryUtils.create(sess, AppConstant.DOCUMENT, EIMConstant.DELETE_USER_ENTRY, 
		...
		if(entryType.getId() == EIMAccessEntryType.GROUP)
		{
			...
			if(workFlow != null)
			{
				...
				OperationHistoryUtils.create(sess, AppConstant.DOCUMENT, EIMConstant.DELETE_GROUP_ENTRY, 
						EIMConstant.TARGET_TO_DELETE_ENTRY, EIMConstant.STATUS_TYPE, (EIMStatusType)sec,
		...
		if(entryType.getId() == EIMAccessEntryType.ROLE)
		{
			...
			if(workFlow != null)
			{
				...
				OperationHistoryUtils.create(sess, AppConstant.DOCUMENT, EIMConstant.DELETE_ROLE_ENTRY, 
						EIMConstant.TARGET_TO_DELETE_ENTRY, EIMConstant.STATUS_TYPE, (EIMStatusType)sec,
		...
		if(entryType.getId() == EIMAccessEntryType.COMP)
		{
			...
			if(workFlow != null)
			{
				...
				OperationHistoryUtils.create(sess, AppConstant.DOCUMENT, EIMConstant.DELETE_COMPLEX_GROUP_ENTRY, 
						EIMConstant.TARGET_TO_DELETE_ENTRY, EIMConstant.STATUS_TYPE, (EIMStatusType)sec,
