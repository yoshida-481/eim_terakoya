...
<%
	...
	try
	{
		...
		//Create Security
		EIMSecurity sec = SecurityUtils.createSecurity(sess, prmDefName);

		/*
		 * Create Security Other
		 */
		for(int i = 0; i < prmOtherCnt; i++)
		{
			...
			// Create Security
			SecurityUtils.addOtherSecurityName(sess, sec.getId(), prmOtherLId, prmOtherName);
		}

		//Create Operation History
		OperationHistoryUtils.create(sess, AppConstant.SYSTEM, EIMConstant.CREATE_SECURITY,
				EIMConstant.TARGET_CREATE, EIMConstant.SECURITY, sec,
				null, null, null, null);
