...
<%
	...
	try
	{
		...
		//Role
		EIMRole role = null;
		if (StringUtils.isBlank(prmRoleId) 
				|| (role = RoleUtils.getRoleById(sess, Long.parseLong(prmRoleId))) == null)
		{
		...
		//User
		EIMUser user = null;
		if (StringUtils.isBlank(prmUserId)
				|| (user = UserUtils.getUserById(sess, Long.parseLong(prmUserId))) == null)
		{
