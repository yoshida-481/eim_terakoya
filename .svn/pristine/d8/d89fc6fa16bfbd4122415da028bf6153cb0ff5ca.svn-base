...
/**
 * メッセージ要素編集クラス  本文　アイテム部：比較対象ファイル名
 *
 */
public class MailElementBodyItemCompareTargetFileNamePlugInImpl extends MailElementPlugInImpl {
	...
	protected Object[] getParams(MailDomain mailDomain, String langId) throws Exception {
		...
		EIMObject object = (EIMObject)EIMThreadContext.get("TARGET.DOC.OBJ");
		if(object == null){
			returnArray[0] = "";
		}
		else{
