 ...
 *
 */
public class MailElementBodyLastEventUserNamePlugInImpl extends MailElementPlugInImpl {
	...
	protected Object[] getParams(MailDomain mailDomain, String langId) throws Exception {
		...
		returnArray[0] = MailUtil.getMailElementBodyItemUserNameAndComment(mailDomain, langId)[0];
		return returnArray;
