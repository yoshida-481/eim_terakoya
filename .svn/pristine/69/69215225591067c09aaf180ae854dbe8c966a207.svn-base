	...
	try
	{
		...
		if(entryType.getId() == EIMAccessEntryType.USER)
		{
			...
			if(workFlow != null)
			{
				...
				OperationHistoryUtils.create(sess, AppConstant.DOCUMENT, EIMConstant.UPDATE_USER_ENTRY_ORDER, 
		...
		if(entryType.getId() == EIMAccessEntryType.GROUP)
		{
			...
			if(workFlow != null)
			{
				...
				OperationHistoryUtils.create(sess, AppConstant.DOCUMENT, EIMConstant.UPDATE_GROUP_ENTRY_ORDER, 
						EIMConstant.TARGET_PARENT_STATUS, EIMConstant.STATUS_TYPE, (EIMStatusType)sec,
		...
		if(entryType.getId() == EIMAccessEntryType.ROLE)
		{
			...
			if(workFlow != null)
			{
				...
				OperationHistoryUtils.create(sess, AppConstant.DOCUMENT, EIMConstant.UPDATE_ROLE_ENTRY_ORDER, 
						EIMConstant.TARGET_PARENT_STATUS, EIMConstant.STATUS_TYPE, (EIMStatusType)sec,
		...
		if(entryType.getId() == EIMAccessEntryType.COMP)
		{
			...
			if(workFlow != null)
			{
				...
				OperationHistoryUtils.create(sess, AppConstant.DOCUMENT, EIMConstant.UPDATE_COMPLEX_GROUP_ENTRY_ORDER, 
						EIMConstant.TARGET_PARENT_STATUS, EIMConstant.STATUS_TYPE, (EIMStatusType)sec,
